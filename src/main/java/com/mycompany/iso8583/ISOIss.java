...
public class ISOIss  extends ISOBasePackager{
    ...
    protected ISOFieldPackager fld[] = {
            ...
            new IFB_NUMERIC   ( 19, "PAN - PRIMARY ACCOUNT NUMBER", true),
            ...
            new IFE_CHAR    (  9, "AMOUNT, TRANSACTION FEE"),
            new IFE_CHAR  (  9, "AMOUNT, SETTLEMENT FEE"),
            new IFE_CHAR  (  9, "AMOUNT, TRANSACTION PROCESSING FEE"),
            new IFE_CHAR  (  9, "AMOUNT, SETTLEMENT PROCESSING FEE"),
            new IFB_NUMERIC   ( 11, "ACQUIRING INSTITUTION IDENT CODE", true),
            new IFB_LLNUM   ( 11, "FORWARDING INSTITUTION IDENT CODE", pad),
            new IFB_LLCHAR  ( 28, "PAN EXTENDED"),
            new IFA_FLLCHAR   ( 37, "TRACK 2 DATA"),
  ...
  /*60*/    new IFB_NUMERIC (999, "RESERVED NATIONAL",true),
            new IFB_LLLCHAR (999, "RESERVED NATIONAL"),
            new IFB_LLLCHAR (999, "RESERVED PRIVATE"),
            new IFB_LLLCHAR (999, "RESERVED PRIVATE"),
          
     /*62*/ new IFB_NUMERIC (999, "RESERVED PRIVATE",pad),
            new IFB_NUMERIC (999, "RESERVED PRIVATE",pad),
            ...
            new IFE_CHAR     (  6, "RESPONSE INDICATOR"),
